from commons.layers import Embedding, SigmoidWithLoss
from commons.np import *  # import numpy as np
import collections
...
class UnigramSampler:
    ...
    def get_negative_sample(self, target):
        ...
        if not GPU:
            ...
            # make speed first when calculate with GPU(cupy）, so negative example can include target
